...
Un filo sul lato destro: 1px a riposo, 5px quando il puntatore si avvicina
al bordo. Il progresso si riempie dall'alto su binario grigio chiaro, e
all'orlo del riempimento un numero in percentuale, ruotato sul fianco, dice
la posizione di scroll. Su fondo chiaro filo e numero sono `#141416`, su
fondo scuro diventano `#ffffff`. L'asta si puo' trascinare per scorrere.
...
<script defer src="https://cdn.jsdelivr.net/gh/cash9086/scroll-bar@e6dd67ced2ced02beacb636caaf512f663f67bf6/cape-scroll-rail.js"></script>
```
